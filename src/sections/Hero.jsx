...
export default function Hero() {
  return (
    <div id="hero" className="py-12 md:py-24 lg:py-32">
      <div className="px-4 xl:container xl:mx-auto xl:px-20 flex flex-col justify-center items-center">
        <div className="xl:mx-2 grid gap-6 lg:grid-cols-2 lg:gap-12 xl:grid-cols-2">
